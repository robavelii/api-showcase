...
class TestFileUploadProperties:
    ...
    **Feature: openapi-showcase, Property 14: File upload acceptance**
    ...
    def test_signed_url_generation_returns_valid_response(
    ...
    def test_signed_url_expiration_is_in_future(
        self, filename: str, content_type: str
    ):
        """
        **Feature: openapi-showcase, Property 14: File upload acceptance**
    ...
    **Feature: openapi-showcase, Property 16: Status endpoint consistency**
    ...
    def test_status_returns_valid_enum_and_progress(self, target_format: str):
        ...
        **Feature: openapi-showcase, Property 16: Status endpoint consistency**
        ...
        assert status.status in [s for s in ConversionStatus]
...
class TestRetryBackoffProperties:
    ...
    **Feature: openapi-showcase, Property 17: Task retry with exponential backoff**
    ...
    def test_backoff_delay_follows_exponential_pattern(
        self, retry_count: int, base_delay: int
    ):
        """
        **Feature: openapi-showcase, Property 17: Task retry with exponential backoff**
...
class TestFileMetadataSerializationProperties:
    ...
    **Feature: openapi-showcase, Property 18: File metadata round-trip**
    ...
    def test_file_metadata_round_trip(
    ...
    @settings(max_examples=50)
    @given(
        status=st.sampled_from([s for s in FileStatus]),
    )
    ...
    def test_conversion_job_response_round_trip(
        self, target_format: str, progress: int
    ):
        """
        **Feature: openapi-showcase, Property 18: File metadata round-trip**
        ...
        """
        import json
        from apps.file_processor.schemas.conversion import ConversionJobResponse
    ...
    @settings(max_examples=50)
    @given(
        status=st.sampled_from([s for s in ConversionStatus]),
        progress=st.integers(min_value=0, max_value=100),
    )
    def test_conversion_status_response_round_trip(
        self, status: ConversionStatus, progress: int
    ):
        """
        **Feature: openapi-showcase, Property 18: File metadata round-trip**
        ...
        """
        import json
        from apps.file_processor.schemas.conversion import ConversionStatusResponse
