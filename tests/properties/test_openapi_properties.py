...
from apps.gateway.openapi_bundler import merge_openapi_specs, create_combined_spec
                        ...
                        if "content" in response:
                            for content_type, content in response["content"].items():
                                ...
                                if "schema" in content:
                                    has_example = has_example or "example" in content.get("schema", {})
                                assert has_example, f"Missing example for {method.upper()} {path} {status_code}"
...
class TestOpenAPIMergeProperties:
    ...
    def test_merged_spec_contains_all_paths(
    ...
    def test_merged_spec_contains_all_schemas(
        self, spec1: dict[str, Any], spec2: dict[str, Any]
    ):
        """
        **Feature: openapi-showcase, Property 29: OpenAPI spec completeness**
