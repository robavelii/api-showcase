...
class TestOrderFilteringProperties:
    ...
    **Feature: openapi-showcase, Property 8: Filter correctness**
    ...
    def test_status_filter_returns_only_matching_orders(
        self, num_orders: int, filter_status: str
    ):
        """
        **Feature: openapi-showcase, Property 8: Filter correctness**
    ...
    def test_customer_id_filter_returns_only_matching_orders(
        self, num_orders: int
    ):
        """
        **Feature: openapi-showcase, Property 8: Filter correctness**
    ...
    def test_date_range_filter_returns_orders_in_range(
        self, num_orders: int
    ):
        """
        **Feature: openapi-showcase, Property 8: Filter correctness**
...
class TestOrderCreationProperties:
    ...
    **Feature: openapi-showcase, Property 10: Order creation idempotency check**
    ...
    def test_order_total_calculated_correctly(
        self, quantity: int, unit_price: Decimal
    ):
        """
        **Feature: openapi-showcase, Property 10: Order creation idempotency check**
...
class TestOrderRetrievalProperties:
    ...
    **Feature: openapi-showcase, Property 11: Order retrieval consistency**
    ...
    def test_created_order_can_be_retrieved(
        self, quantity: int, unit_price: Decimal
    ):
        """
        **Feature: openapi-showcase, Property 11: Order retrieval consistency**
...
class TestOrderUpdateProperties:
    ...
    **Feature: openapi-showcase, Property 12: Order update persistence**
    ...
    @settings(max_examples=50)
    @given(
        new_street=st.text(min_size=1, max_size=50, alphabet="abcdefghijklmnopqrstuvwxyz0123456789 "),
    )
...
class TestWebhookSignatureProperties:
    ...
    **Feature: openapi-showcase, Property 13: Webhook signature verification**
    ...
    @settings(max_examples=100)
    @given(
        payload_content=st.text(min_size=1, max_size=500, alphabet="abcdefghijklmnopqrstuvwxyz0123456789{}\":, "),
    )
    ...
    @settings(max_examples=100)
    @given(
        payload_content=st.text(min_size=1, max_size=200, alphabet="abcdefghijklmnopqrstuvwxyz0123456789{}\":, "),
        tampered_content=st.text(min_size=1, max_size=200, alphabet="abcdefghijklmnopqrstuvwxyz0123456789{}\":, "),
    )
    def test_modified_payload_is_rejected(
        self, payload_content: str, tampered_content: str
    ):
        """
        **Feature: openapi-showcase, Property 13: Webhook signature verification**
    ...
    @given(
        payload_content=st.text(min_size=1, max_size=200, alphabet="abcdefghijklmnopqrstuvwxyz0123456789{}\":, "),
        wrong_secret=st.text(min_size=10, max_size=50, alphabet="abcdefghijklmnopqrstuvwxyz0123456789"),
    )
    def test_wrong_secret_is_rejected(
        self, payload_content: str, wrong_secret: str
    ):
        """
        **Feature: openapi-showcase, Property 13: Webhook signature verification**
