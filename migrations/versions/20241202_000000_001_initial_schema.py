...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Uuid(), nullable=False),
        sa.Column('user_id', sa.Uuid(), nullable=False),
        sa.Column('status', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False, default='pending'),
    ...
    op.create_table(
        ...
        sa.Column('type', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False, default='info'),
    ...
    op.create_table(
        ...
        sa.Column('path', sqlmodel.sql.sqltypes.AutoString(length=2048), nullable=False, default='/'),
        sa.Column('headers', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('body', sa.Text(), nullable=False, default=''),
        sa.Column('content_type', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False, default=''),
        sa.Column('source_ip', sqlmodel.sql.sqltypes.AutoString(length=45), nullable=False, default=''),
